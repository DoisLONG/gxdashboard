<template>
  <div class="bottom-charts">
    ...
    <dv-decoration-2 v-if="!isMobile" class="decoration-1" :reverse="true" style="width:5px;" />
    ...
    <dv-decoration-2 v-if="!isMobile" class="decoration-2" :reverse="true" style="width:5px;" />
    ...
    <dv-decoration-2 v-if="!isMobile" class="decoration-3" :reverse="true" style="width:5px;" />
